  ...
  return (
    <div className="flex flex-col">
      ...
      <div className=" flex  items-center gap-5 my-8 ml-2">
        <Image src={`/Icon.svg`} alt="icon" height={10} width={15} />
        <h3 className="text-gray-600">Performance</h3>
      </div>
      {/* logo end  */}
      <div
        onClick={handleProjectSummary}
        className="md:min-w-[30rem] max-w-[32rem] shadow-xl px-8 py-3 rounded-2xl bg-[#fff] cursor-pointer"
      >
        <div className="flex justify-between pt-4 pb-6 px-2 cursor-pointer">
